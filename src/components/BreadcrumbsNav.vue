<template>
    <div
        class="absolute top-10 left-1/2 -translate-x-2/4 -translate-y-2/4 z-20 w-11/12 text-gray-500 mx-auto flex  items-center gap-2">
        <RouterLink :to="{ name: 'home' }" active-class=" text-white" class="first-letter:uppercase">
            home
        </RouterLink>
        <span v-if="$route.fullPath !== '/'">|</span>
